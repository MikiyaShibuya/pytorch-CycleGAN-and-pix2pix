...
class Visualizer():
    ...
    def __init__(self, opt):
        ...
        if self.display_id > 0:  # connect to a visdom server given <display_port> and <display_server>
            ...
            tb_dir = os.path.join(opt.checkpoints_dir, opt.name, 'tb_summary')
            self.writer = SummaryWriter(tb_dir)
            self.writer_plot_count = 0
    ...
    def display_current_results(self, visuals, epoch, save_result, tag='image'):
